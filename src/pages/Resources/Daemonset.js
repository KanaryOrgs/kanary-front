...
const sampleData = [
    ...
    },
    {
      ...
      ready: 0, // 가정된 값
      available: 0, // 가정된 값
      nodeSelector: "app=httpbin", // 가정된 값
    },
    {
    ...
    },
    {
      ...
      ready: 2, // 가정된 값
      available: 2, // 가정된 값
      nodeSelector: "app=coredns", // 가정된 값
    },
    {
    ...
    },
    {
      ...
      ready: 1, // 가정된 값
      available: 1, // 가정된 값
      nodeSelector: "app=kube-apiserver", // 가정된 값
    },
    {
      ...
      ready: 1, // 가정된 값
      available: 1, // 가정된 값
      nodeSelector: "app=kube-controller-manager", // 가정된 값
    },
    {
      ...
      ready: 2, // 가정된 값
      available: 2, // 가정된 값
      nodeSelector: "app=kube-proxy", // 가정된 값
    },
    {
    ...
    },
    {
      ...
      ready: 1, // 가정된 값
      available: 1, // 가정된 값
      nodeSelector: "app=kube-scheduler", // 가정된 값
    },
  ];
                  ...
                  <CDBTableBody>
                    {currentPageData.map((row, index) => (
                      <tr key={index}>
                        <td>{row.name}</td>
                        <td>{row.namespace}</td>
                        <td>{row.images.join(", ")}</td> {/* images 배열을 문자열로 변환 */}
                        <td>{row.labels}</td>
                        <td>{row.current}</td>
                        <td>{row.ready}</td>
                        <td>{row.available}</td>
                        <td>{row.nodeSelector}</td>
                        <td>

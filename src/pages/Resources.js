...
export const Resources = () => {
	...
	return (
		<div className="d-flex Resources">
			<div>
      	<Sidebar/>
			</div>
							...
							<div  className="cards-container1">
								<div>
									<div className="card shadow border-0">
										<img alt="ResourcesImage" src="/img/pages/heroImage2.png" className="w-100" style={{objectFit:"cover", maxHeight:"500px"}}/>
								...
								<div>
									<div className="card shadow border-0">
										...
										<div className="card-footer">
											<a className="p-2" href="#Resources">
												Live Preview
								...
								<div>
									<div className="card shadow border-0">
										...
										<div className="card-footer text-center">
											<a className="p-2" href="#Resources">Live Preview<i className="far fa-image ml-1"></i></a>
										</div>
									</div>
								</div>
								<div>
